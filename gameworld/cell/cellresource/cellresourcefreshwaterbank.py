...
class CellResourceFreshWaterBank(CellResource):
    ...
    def get_loader_colour():
        # in practise fresh water banks will be loaded after scanning all lake/river cells
        # else we'll have to draw on the png every single fresh water bank cell
        assert(False)
