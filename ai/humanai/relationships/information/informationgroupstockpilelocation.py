...
class InformationGroupStockpileLocation(InformationLocation):
    ...
    def __init__(self, location, group_id):
    ...
    def register_to_knowledge(self, human):
        human.knowledge_group_stockpile_locations.register_from_information(human, self)
