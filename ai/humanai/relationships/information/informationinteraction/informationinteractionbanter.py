...
class InformationInteractionBanter(InformationInteraction):
    ...
    def get_memory_cache_values(self, witness):
        ...
        if human_witness_id == self.initiator_id or human_witness_id == self.participant_id:
            ...
            """
            If banter is successful, both: lose fear for each other, increase love and respect for each other
        ...
        # human_witness_id is a witness
            ...
            """
            A witness may be jealous of an interaction if he dislikes and likes other parties respectively.
            In this case he will love some love for the person he likes proportional to how much he dislikes the other
            person.
            """
            ...
            iniator_love_score_as_percent = 1 - ((iniator_love_score + 1) / 2)
            participant_love_score_as_percent = 1 - ((participant_love_score + 1) / 2)

            # if he likes the initator but not participant, decrement love of him by amount he hates participant * jealousy constant
            if iniator_love_score > 0:
                return [( self.initiator_id, participant_love_score_as_percent * jealously_constant, 0, 0)]
            elif participant_love_score > 0:
                return [( self.participant_id, iniator_love_score_as_percent * jealously_constant, 0, 0)]
            return []
