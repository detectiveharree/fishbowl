...
class InformationInteractionFightBattle(InformationInteractionFight):
    ...
    def get_memory_cache_values(self, witness):
        ...
        initiator_delta_score = (self.initiator_id, 0, 0, 0)
        participant_delta_score = (self.participant_id, 0, 0, 0)
        ...
        # human_witness_id is a witness
            ...
            Equivalent to brawl pretty much, less anger because it's more expected, but more hate.
            """

            BASE_LOVE_DELTA = 50 # base decrease in love for init for starting the fight
