...
class ActionInteractCellSocialisingTavern(ActionInteractCellBuildingInteract):
    ...
    def __init__(self, interaction):
        super().__init__(BUILDING_TYPE.TAVERN, interaction) # ALWAYS CALL PARENT CONSTRUCTOR


    def __str__(self):
        return "Socialising (%s) with %s in building %s" % (self.interact_type.get_interaction_type(), self.current_interaction_target, self.building_type)
