...
class ItemArmourPlate(ItemArmour):
    ...
    """
    @staticmethod
    def lookup_storage(plate_material, group):
        return group.knowledge_group_item_inventory.inventory_plate[plate_material]
    ...
    def __str__(self):
        return f'{self.material} plate armour'